...
/// Funkcja odpowiedzialna za inicjowanie nowej wizyty; jest rekurencyjna i jako parametry pobiera ID pacjenta, lekarza i wizyty oraz dokladny czas planowania takiej wizyty; pozwala ona na dokladne ustalenie szczegolow wizyty pacjenta u wybranego lekarza; funkcja posaida szereg zabezpieczen przed niewlasciwymi danymi.
...
/// Funkcja wczytujaca wizyty z pliku "Baza_Rejestracja.txt"; dziala analogicznie do 2 poprzednich funkcji, wczytujacych dane z pliku.
...
///Funkcja zapisujaca wszystkie wizyty do pliku tekstowego, dzialajaca analogicznie do wczesniejszych funkcji, zapisujacych dane do pliku.
...
/// Funkcja wyswietlajaca wszystkie zainicjowane wizyty na ekranie; obejmuje wszystkie wizyty wraz ze szczegolami; pobiera niezbedne dane ze struktur z pacjentami i lekarzami.
int pokaz_wizyty(){
...
/// Funkcja pozwalajaca na szczegolowa edycje danych zawartych w wizytach; pozwala na odwolanie lub zmiane terminu wizyty wraz z doborem wszystkich szczegolowych parametrow (zwiazanych z czasem trwania wizyty, jej poczatkiem, koncem etc).
...
/// Funkcja pozwalajaca na wypisywanie wizyt wedlug wpisanego ID.
int wyswietl_wizyty_po_id1(){
...
/// Funkcja pokazujaca wizyty danego pacjenta po jego numerze ID (wizyty zaplanowane, odbyte i odwolane); jest to funkcja posiadajaca rekursje.Funkcja pokazujaca wizyty danego pacjenta po jego numerze ID (wizyty zaplanowane, odbyte i odwolane); jest to funkcja posiadajaca rekursje.
...
/// Funkcja wyswietla wszystkie wizyty danego lekarza wedlug podanego ID; pozwala pokazac wizyty odbyte, zaplanowane i odwolane.
...
/// Funkcja wyswietlajaca wszystkie wizyty wedlug wprowadzonego ID wizyty, pokazujaca wszystkie szczegolowe dane kazdej z wizyt.
int wyswietl_wizyty_po_id(){
...
/// Funkcja pozwalajaca na zmiane statusu wybranej wizyty; obsluguje ona zmiane statusu wizyty na wlasciwy.
