...
/// Funkcja odpowiedzialna za tworzenie nowego wpisu lekarza; najpierw alokowana jest odpowiednia ilosc pamieci, potem obsluga bledow zwiazanych wlasnie z alokacja pamieci dla wskaznika 'dodaj_wpis1', odpowiedzialnego za dane lekarzy; funkcja ta pozwala rowniez na wprowadzenie godzin pracy lekarza.
...
/// Funkcja odpowiadajaca za wyswietlanie listy zapisanych lekarzy. Dziala podobnie jak funkcja 'pokaz_pacjentow()'; zastosowalismy tu petle while() i przechodzenie do kazdego kolejnego elementu listy.
void pokaz_lekarzy(){
...
/// Funkcja pozwalajaca na wczytanie listy lekarzy z pliku "Baza_Przychodnia_Lekarze.txt".
...
/// Funkcja zapisujaca liste wszystkich lekarzy do pliku "Baza_Przychodnia_Lekarze.txt".
...
/// Funkcja odpowiadajaca za usuwanie lekarzy. Oparta jest na petli while(), czyszczac kazdy element, przechodzac kolejno az do napotkania wartosci NULL we wskazniku 'poczatek1'; zastosowano tu funkcje 'free();'.
...
/// Funkcja pozwalajaca na edycje danych lekarzy; elementem, wg ktorego dokonujemy edycji danych, jest ID; zastosowano tu szereg zabezpieczen, niezbednych do prawidlowego wprowadzenia zadanych danych.
int edycja_lekarzy(){
...
/// Menu pozwalajace na wyszukiwanie lekarzy po ID, imieniu, nazwisku, numeru PESEL, numerze PWZ, tytule zawodowym i specjalizacji; zastosowano tu odpowiednie zabezpieczenia przed wprowadzeniem niewlasciwych danych.
...
/// Funkcja pozwalajca na wyswietlenie szczegolowych danych konkretnego lekarza.
void wyswietl_dane_lekarzy(){
...
/// Funkcja pozwala na zamiane danych 2 lekarzy, przekazanych przez argument funkcji jako 2 wskazniki do odpowiednich struktur.
...
/// Funkcja sortujaca lekarzy rosnaco.
...
/// Funkcja sortujaca lekarzy malejaco.
