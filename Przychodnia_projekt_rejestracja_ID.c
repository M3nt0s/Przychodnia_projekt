...
<br><p> Pokazanie danych Pacjentow (przed sortowaniem i po - wg. nazwiska):</p>
\image html posort_pacjenci_przed.png
<br><br>
\image html posort_pacjenci_po.png
...
/// Funkcja odpowiedzialna za odczyt dokladnych dat; jesli data jest nieprawidlowo podana, wystapi blad.
int odczyt_dni(int rok, int miesiac, int dzien){
